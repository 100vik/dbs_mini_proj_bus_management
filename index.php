  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container clearfix">
      <div class="contact-info float-left">
        <i class="fa fa-envelope-o"></i> <a href="mailto:contact@example.com">rapidtransit@gmail.com</a>
        <i class="fa fa-phone"></i> +91 6294773940
      </div>
    </div>
  </section> -->
  ...
  <div class="container">
    ...
    <nav id="nav-menu-container">
      <ul class="nav-menu">
        ...
        <li><div class="btn-admin" onclick="window.location.href='registration/admin.php'">Admin Login</div></li>
<li><div class="btn-login" onclick="window.location.href='registration/login.php'">User Login</div></li>
      </ul>
